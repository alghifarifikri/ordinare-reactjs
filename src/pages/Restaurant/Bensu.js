...
import { getBensu } from '../../redux/action/Restaurant/Bensu'

class Bensu extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            data : {},
...
export default connect (mapStateToProps) (Bensu)