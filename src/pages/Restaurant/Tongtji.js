...
import { getTongtji } from '../../redux/action/Restaurant/Tongtji'

class Tongtji extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            data : {},
    ...
    async componentDidMount(){
        ...
        this.props.dispatch(getTongtji())
...
const mapStateToProps = state =>{
    return{
        tongtji: state.tongtji
    }
  }

export default connect (mapStateToProps) (Tongtji)