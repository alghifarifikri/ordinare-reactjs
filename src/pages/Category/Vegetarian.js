...
import { getVegetarian } from '../../redux/action/Category/Vegetarian'
...
class Vegetarian extends React.Component{
    ...
    async componentDidMount(){
        ...
        this.props.dispatch(getVegetarian())
