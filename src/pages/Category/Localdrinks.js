...
import { getLocalDrinks } from '../../redux/action/Category/Localdrinks'
import { connect } from 'react-redux'

class Localdrinks extends React.Component{
    constructor(props){
        super(props)
        this.state = {
            data : {},
    ...
    async componentDidMount(){
        ...
        this.props.dispatch(getLocalDrinks())
